            ...
            dist: {
                ...
                options: {
                    ...
                    sections: {
                        ...
                        get: '<%= fixturesPath %>/**/get.html',
                        faq: '<%= fixturesPath %>/**/faq.html',
                        reviews: '<%= fixturesPath %>/**/reviews.html',
                        gallery: '<%= fixturesPath %>/**/gallery.html',
                        gallerymain01: '<%= fixturesPath %>/**/gallerymain01.html',
                        gallerymain02: '<%= fixturesPath %>/**/gallerymain02.html',
                        map: '<%= fixturesPath %>/**/map.html',
